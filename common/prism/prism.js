/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+css-extras+docker+git+go+http+icon+ini+java+javadoclike+jq+js-extras+json+json5+markdown+markup-templating+nginx+php+phpdoc+php-extras+plsql+powershell+python+sql+typescript+visual-basic&plugins=line-highlight+line-numbers+highlight-keywords+remove-initial-line-feed+inline-color+toolbar+copy-to-clipboard */
...
!function(e){
    var i = e.languages.powershell = {
        ...
        function: [
            ...
            /\b(?:ac|cat|chdir|clc|cli|clp|clv|compare|copy|cp|cpi|cpp|cvpa|dbp|del|diff|dir|ebp|echo|epal|epcsv|epsn|erase|fc|fl|ft|fw|gal|gbp|gc|gci|gcs|gdr|gi|gl|gm|gp|gps|group|gsv|gu|gv|gwmi|iex|ii|ipal|ipcsv|ipsn|irm|iwmi|iwr|kill|lp|ls|man|md|mkdir|move|mp|mv|nal|ndr|ni|nmo|npssc|nsn|nv|ogv|oh|popd|ps|pushd|pwd|r|rbp|rcjb|rcsn|rd|rdr|ren|ri|rjb|rm|rmdir|rmo|rni|rnp|rp|rsn|rsnp|rujb|rv|rvpa|rwmi|sajb|sal|saps|sasv|sbp|sc|select|set|shcm|si|sl|sleep|sls|sort|sp|spjb|spps|spsv|start|sujb|sv|swmi|tee|trcm|type|where|wjb|write)\b/i
        ],
        keyword: /\b(?:Begin|Break|Catch|Class|Continue|Data|Define|Do|DynamicParam|Else|ElseIf|End|Exit|Filter|Finally|For|ForEach|From|Function|If|InlineScript|Param|Process|Return|Switch|Throw|Trap|Try|Until|Using|Var|While|Workflow)\b/i,
        operator: {
            pattern: /(^|\W)(?:!|-(?:b?(?:and|or|xor|not)|as|(?:does|i)?(?:eq|ne|[gl][te])|(?:i|c)?(?:s?like|match|contains|in)|replace|join|is(?:not)?|exact|casesensitive))\b/i,
            lookbehind: !0
        },
        punctuation: /[|{}[\];(),.]/
    };
